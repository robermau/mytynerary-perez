...
const Cards = () => {
    ...
    return (
        <div  className="cardContainer">
            {data.map(item =>
                <div key={item.id} className="w-1/4 max-w-sm m-6 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                    ...
                    <div className="p-2">
                        ...
                        <p className="mb-1 text-base text-gray-700 dark:text-gray-400">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p>
