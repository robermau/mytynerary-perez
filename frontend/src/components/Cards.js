...
const Cards = ({city}) => {
    ...
    return (
      <div className="mb-8 mr-4 bg-white border border-gray-200 rounded-lg shadow-lg hover:-translate-y-6 shadow-gray-900 w-80 dark:bg-gray-800 dark:border-gray-700">
